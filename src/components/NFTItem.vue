      ...
      <div class="cover-padding">
        <div class="cover" @click="goDetail">
          <el-image
            class="cover-image"
            placeholder="loading"
            :src="$filters.fullImageUrl(nftURI.imgUrl)"
            fit="contain"
          >
          ...
          <div class="d-left d-top">
            <div class="avatar">
              <avatar
                ...
                :imageUrl="$filters.fullImageUrl(nftURI.imgUrl)"
                :imgWidth="18"
                :imgHeight="18"
                shape="circular"
              ></avatar>
...
export default {
  ...
  computed: {
    ...
    nftURI2() {
      // if (this.nft.nft.metadataContent) {
        console.log('committed',this.nft.contentHash);
        var contentHash = this.$web3.getnfturl(this.nft.contentHash);
        this.nft.address = contentHash;
       console.log('contentHash',this.nft.address);
       console.log('url',this.nft.url);
        return this.$tools.analysis(this.nft);
      // }else if (this.nft.media) {
      //   return this.$tools.analysis(this.nft.media);
      // }
      // return {};
  ...
  methods: {
    ...
    showDialog(name, asset) {
      ...
      if (name == "opensea") {
        let url = this.openseaUrl + nft.txHash;
